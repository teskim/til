...
- 20260322: 논문에서는 greedy search로 파라미터별로 최적의 파라미터를 찾았다고 함. 그리고 ABT에 사용한 A그룹은 pCTCVR 랭킹이었고, 이걸 linear weighted sum으로 진행했는데 다른 요소들을 올리면서 conversion은 떨어지지 않았으므로 성공적.
